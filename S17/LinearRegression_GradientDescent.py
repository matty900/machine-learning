...
# Normalization
# NOTE: for linear regression no need for normalizaiton as it's find the suit spot
# However, when using SGDRegressor with linear regression we need normalization
sc = StandardScaler()
